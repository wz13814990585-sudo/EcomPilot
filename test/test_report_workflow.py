...
from ecom_agent_matrix.workflows.report.workflow import handle_report, run_report_workflow
...
def test_ops_report_skill_error_code_preserved():
    failure = SkillResult(success=False, error_code="SKILL_TIMEOUT", error_msg="timeout")

    async def scenario():
        with patch(
            "ecom_agent_matrix.workflows.report.workflow.exec_skill",
