...
|---|---|---|---|---|---|---|
| data_analysis | RULE_DATA_ANALYSIS | Query | DataIntelligenceService | PostgreSQL | 240 orders | PASS |
| knowledge_qa | RULE_KNOWLEDGE | RAG | RAGService | pgvector / lexical | 20 documents | PASS |
| goods_search | RULE_GOODS_SEARCH | Query | goods workflow | ecom_goods | 24 products | PASS |
| goods_catalog | RULE_GOODS_CATALOG | Query | goods workflow | ecom_goods | 24 products | PASS |
| stock_analysis | RULE_STOCK | Query | stock workflow | goods + orders | low/OOS products | PASS |
| competitor_watch | RULE_COMPETITOR | Query | competitor workflow | competitor_price | 80 observations | PASS |
