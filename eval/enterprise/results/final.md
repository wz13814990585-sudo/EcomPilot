...
| execution_success_rate | NOT_RUN | 1.0 | NOT_RUN |
| execution_accuracy | NOT_RUN | 1.0 | NOT_RUN |
...
- Gold SQL execution: **PASS**
- Question-to-SQL execution: **PASS**
- DB security / analytical: **PASS**
- RAG live: **NOT_RUN**
